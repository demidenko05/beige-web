...
<div class="input-line">
  ...
  <select name="${parOpr1}" onchange="bsFltOprChd(this, '${parVl1}');">
  ...
  <input id="${parVl1}" type="date" ${dsbl} required name="${parVl1}" value="${rvs.uvs.fltMp[parVl1]}" onchange="bsInpChn(this);">
  ...
  <select name="${parOpr2}" onchange="bsFltOprChd(this, '${parVl2}');">
  ...
  <input id="${parVl2}" type="date" ${dsbl} required name="${parVl2}" value="${rvs.uvs.fltMp[parVl2]}" onchange="bsInpChn(this);">
</div>
